...
/**
 * repository_mycoursesfiles class is used to navigate files for the courses in which you are associated (Enrolled).
 *
 * @since 2.0
 * @package    contrib
 * @subpackage repository
 * @copyright  2012 Erick Torres <ericktorresh@gmail.com> (Modified from code originally written by Dongsheng Cai <dongsheng@moodle.com>)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

class repository_mycoursesfiles extends repository {

    /**
     * mycoursesfiles plugin doesn't require login, so list all files
     * @return mixed
     */
		...
		$context = get_context_instance_by_id(clean_param($params['contextid'], PARAM_INT));
            ...
            if (count($courses)) {
                ...
                foreach ($courses as $course) {
                    ...
                    if ($fileinfo = $browser->get_file_info($coursecontext, $component, $filearea, $itemid, $filepath, $filename)) {
        ...
        if ($fileinfo = $browser->get_file_info($context, $component, $filearea, $itemid, $filepath, $filename)) {
            ...
            foreach ($children as $child) {
                if ($child->is_directory()) {
                    ...
                    // hide user_private area from mycoursesfiles plugin, user should
    ...
    /**
     * mycoursesfiles file don't support to link to external links
     *
     * @return int
     */
